...
public class HooksDemoSteps {
	 ...
	 * 
	 * @Before(value = "@smoke", order = 1) public void browserSetup() throws
	 ...
	 * 
	 * // 1 launch browser WebDriverManager.chromedriver().setup(); driver = new
	 * ChromeDriver();
	 * 
	 * // 2 open url driver.get("https://opensource-demo.orangehrmlive.com/");
	 * Thread.sleep(5000); // driver.manage().timeouts().pageLoadTimeout(20,
	 * TimeUnit.SECONDS); // driver.manage().timeouts().implicitlyWait(10,
	 * TimeUnit.SECONDS); driver.manage().window().maximize();
	 * 
	 * // 3 provide data driver.findElement(By.name("username")).sendKeys("admin");
	 * driver.findElement(By.name("password")).sendKeys("admin123");
	 * 
	 * // 4 click submit buton driver.findElement(By.xpath("password")).click();
	 * 
	 * }
	 * 
	 * @Before(order = 0) public void setup2() {
	 * System.out.println("   I am inside setup2 \n"); }
	 * 
	 * @After(order = 1) public void teardown() {
	 * System.out.println("   I am inside teardown"); driver.close(); driver.quit();
	 * }
	 * 
	 * @After(order = 2) public void teardown2() {
	 * System.out.println("  I am inside teardown2 \n"); }
	 * 
	 * @BeforeStep public void beforeSteps() {
